package com.jphy.lottery.pages;
...
public class LoginPage {
	/** 登陆页面上的：用户名输入框 */
	public static final By LP_INPUT_USERNAME = By.id("user");
	/** 登陆页面上的：密码输入框 */
	public static final By LP_INPUT_PASSCODE = By.id("password");
	/** 登陆页面上的：登陆按钮 */
	public static final By LP_BUTTON_LOGIN = By.id("login");
	/** 登陆页面上的：自动登陆label */
//	public static final By LP_LABEL_AUTO = By.xpath("//*[@id='loginform']/*/label");
	/** 登陆页面上的：记住用户名checkbox */
	public static final By LP_CHECKBOX_REMEMBER = By.id("check");
	/** 登陆页面上的：关闭按钮 */
