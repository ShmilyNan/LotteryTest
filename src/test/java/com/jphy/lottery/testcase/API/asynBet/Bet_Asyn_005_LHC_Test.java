 ...
 */
public class Bet_Asyn_005_LHC_Test {
    public static Logger logger = Logger.getLogger(Bet_Asyn_005_LHC_Test.class.getName());

    @Test(invocationCount = 1)
    public void orderBetting(ITestContext context) {
        final String filePath = "./src/test/resources/data/LHCBetDatas.xml";
        final int lotteryType = 7;
